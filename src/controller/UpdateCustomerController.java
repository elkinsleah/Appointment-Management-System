...
public class UpdateCustomerController implements Initializable {
         ...
         * */
        public void updateMode(Customer updateCustomer) throws IOException {
         ...
         * Update Mode is used to update the selected Customer in the database.
        ...
        public void onActionSaveButton(ActionEvent event) throws IOException {
                ...
                if (!checkErrors) {
                        ...
                        alert.setHeaderText("Customer successfully Updated!");
                        Optional<ButtonType> result = alert.showAndWait();
